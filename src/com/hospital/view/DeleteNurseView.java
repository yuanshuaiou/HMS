...
public class DeleteNurseView {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DeleteNurseView window = new DeleteNurseView();
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel_1 = new JLabel("注销护士账户");
        ...
        JLabel lblNewLabel_2 = new JLabel("请输入要注销的护士ID：");
