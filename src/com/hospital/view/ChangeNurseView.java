...
public class ChangeNurseView {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ChangeNurseView window = new ChangeNurseView();
    ...
    private void initialize() {
        ...
        lblNewLabel.setIcon(new ImageIcon("image\\img4.jpg"));
        lblNewLabel.setBounds(0,0,800,600);

        JLabel lblNewLabel_1 = new JLabel("修改护士信息");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String nname=textField_1.getText();
                String nage=textField_2.getText();
                String nsex=textField_3.getText();
                String nphone=textField_4.getText();
                String ntitle=textField_5.getText();
                String ndeptid=textField_6.getText();
                String ndeptname=textField_7.getText();
                String npassword=new String(textField_8.getPassword());
                String npassword1=new String(textField_9.getPassword());
                ...
                else if(ntitle.equals("")){
                    Tools.showMessage("请输入职称！");
                }
                else if(ndeptid.equals("")){
                    Tools.showMessage("请输入科室编号！");
                }
                else if(ndeptname.equals("")){
                    Tools.showMessage("请输入科室名！");
                }
                else if(!npassword.equals(npassword1)){
                    Tools.showMessage("两次密码不一致！");
                }
                else{
                    int a= NurseDao.editNurse(nid,nname,nage,nsex,nphone,ntitle,ndeptid,ndeptname,npassword);
