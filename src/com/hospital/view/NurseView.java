...
public class NurseView {
    ...
    private void initialize() {
        ...
        mntmNewMenuItem_1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                frame.dispose();
                NSearchPatientView nsearchPatientView = new NSearchPatientView();
                nsearchPatientView.frame.setVisible(true);
            }
        });

        JMenu mnNewMenu_1 = new JMenu("药品查询");
        menuBar.add(mnNewMenu_1);

        JMenuItem mntmNewMenuItem_2 = new JMenuItem("查询药品信息");
