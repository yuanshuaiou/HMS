...
public class DeletePatientView {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DeletePatientView window = new DeletePatientView();
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel_1 = new JLabel("病人办理出院");
        ...
        JLabel lblNewLabel_2 = new JLabel("请输入要办理出院的病人ID：");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(id.equals("")) {
                    ...
                    int a= PatientDao.deletePatient(id);
                    if(a==1){
                        Tools.showMessage("办理出院成功！");
                    }
                    else{
                        Tools.showMessage("找不到该患者，办理出院失败！");
                    }
                }
            }
        });
