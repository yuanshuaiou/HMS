...
public class SearchNurseView {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SearchNurseView window = new SearchNurseView();
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel_1 = new JLabel("搜索护士");
        ...
        JLabel lblNewLabel_2 = new JLabel("请输入要搜索的护士ID：");
...
//以下创建表格的位置待移动到显示表格的位置
        Object col[]={"编号","姓名","性别","年龄","性别","电话","职称","科室号","科室名","密码"};
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(id.equals("")) {
                    ...
                    Nurse nur=new NurseDao().getnurse(id);
                    try {
