...
public class RegisterNurseView {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    RegisterNurseView window = new RegisterNurseView();
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel_1 = new JLabel("护士注册");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(nid.equals("")){
                    ...
                    int a= NurseDao.registerNurse(nid,nname,nage,nsex,nphone,ntitle,ndeptid,ndeptname,npassword);
                    if(a==0){
