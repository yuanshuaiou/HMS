...
public class ChangeDoctorView {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ChangeDoctorView window = new ChangeDoctorView();
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel_1 = new JLabel("修改医生信息");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(did.equals("")){
                    ...
                    int a= DoctorDao.editdoctor(did,dname,dage,dsex,dphone,dtitle,ddeptid,ddeptname,dpassword);
